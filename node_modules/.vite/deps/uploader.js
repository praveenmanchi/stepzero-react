...
function o(o2, e, n, t, f, l2) {
  ...
  for (u in e)
    "ref" == u ? s = e[u] : a[u] = e[u];
  var i = { type: o2, props: a, key: n, ref: s, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: --_2, __source: f, __self: l2 };
              ...
              var beginFileUpload = Upload_async(function(file, params, addCancellationHandler) {
                ...
                return withProgressReporting(onProgressInterval, reportProgress, Upload_async(function() {
                  ...
                  return _await((0, upload_api_client_upload_js_namespaceObject.beginMultipartUpload)(getConfig(), accountId, uploadRequest), function(_beginMultipartUpload) {
                    ...
                    var incUploadIndex = /* @__PURE__ */ function() {
    ...
    (function() {
      ...
      !function() {
        ...
        function hexToRgb(hex) {
          ...
          hex = hex.replace(shorthandRegex, function(_3, r, g, b) {
        ...
        function highlightColor(hex, amount) {
          ...
          var clipToFactor = function clipToFactor2(x) {
        ...
        (function(UploadWidgetConfigRequired2) {
          function from(options2) {
            ...
            return {
              ...
              mimeTypes: (_c = options2.mimeTypes) === null || _c === void 0 ? void 0 : _c.map(function(x) {
        ...
        function Modal_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return Modal_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function UseDimensionsFromElement_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UseDimensionsFromElement_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function useElementRef() {
          ...
          var elementRef = (0, compat_namespaceObject.useCallback)(function(e) {
            setElement(e !== null && e !== void 0 ? e : void 0);
          }, []);
        ...
        function WidgetBase_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return WidgetBase_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        var WidgetBase_WidgetBase = function WidgetBase2(_ref) {
          ...
          var breakpoint = (_b = dimensions === void 0 ? void 0 : (_a = breakpoints.find(function(x) {
        ...
        function UploadButton_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UploadButton_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function ProgressIcon_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return ProgressIcon_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function SubmittedFileComponent_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return SubmittedFileComponent_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function UseDragDrop_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UseDragDrop_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function Draggable_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return Draggable_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        var Draggable = function Draggable2(_ref) {
          ...
          var setPositionStart = function setPositionStart2(e) {
            setStartX(e.pageX);
            setStartY(e.pageY);
          };
          var getPositionDelta = function getPositionDelta2(e) {
            return {
              x: e.pageX - startX + lastXDelta,
              y: e.pageY - startY + lastYDelta
            };
          };
          var onDown = function onDown2(e) {
            e.stopPropagation();
        ...
        function ResizableSquare_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return ResizableSquare_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        var ResizableSquare_ResizableSquare = function ResizableSquare2(_ref2) {
          ...
          var reRatio = function reRatio2(g, fixed) {
            if (ratio === void 0) {
          ...
          var clip = function clip2(g) {
            var x = Math.min(boundary.width - minSize, Math.max(0, g.x));
          ...
          var clipAndReRatio = function clipAndReRatio2(g, fixed) {
        ...
        function Spinner_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return Spinner_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function ImageEditorLayout_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return ImageEditorLayout_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function FormUtils_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return FormUtils_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function SubmitButton_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return SubmitButton_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        var SubmitButton = function SubmitButton2(_ref) {
          ...
          var submitAsync = function submitAsync2(e) {
            e.preventDefault();
        ...
        function ImageCropper_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return ImageCropper_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function UseImageList_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UseImageList_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function UseShowImageEditor_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UseShowImageEditor_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function UploadWidget_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UploadWidget_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        var UploadWidget_rest = function(s, e) {
          var t = {};
          for (var p in s) {
            if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
              t[p] = s[p];
        ...
        function isValidMimeType(allowedMimeTypes, actualMimeType) {
          ...
          var normalize = function normalize2(x) {
            return x.trim().toLowerCase();
          };
        ...
        var UploadWidget = function UploadWidget2(_ref) {
          ...
          var removeSubmittedFile = function removeSubmittedFile2(fileIndex) {
            setSubmittedFiles(function(x) {
              var _a2 = x, _b2 = fileIndex, removed = _a2[_b2], rest = UploadWidget_rest(_a2, [_typeof(_b2) === "symbol" ? _b2 : _b2 + ""]);
        ...
        function ModalContainer_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return ModalContainer_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function RootContainer_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return RootContainer_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
        ...
        function UploadManager_unsupportedIterableToArray(o2, minLen) {
          if (!o2)
            return;
          if (typeof o2 === "string")
            return UploadManager_arrayLikeToArray(o2, minLen);
          var n = Object.prototype.toString.call(o2).slice(8, -1);
          if (n === "Object" && o2.constructor)
            n = o2.constructor.name;
          if (n === "Map" || n === "Set")
