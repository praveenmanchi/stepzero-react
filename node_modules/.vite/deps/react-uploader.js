...
// node_modules/react-uploader/dist/main.js
var require_main = __commonJS({
  "node_modules/react-uploader/dist/main.js"(exports, module) {
    (function() {
      "use strict";
      ...
      function useAutoUpdatingOptions(optionsMaybe) {
        ...
        return Object.assign(Object.assign({}, optionsMaybe), {
          onInit: function onInit(m) {
            if ((optionsMaybe === null || optionsMaybe === void 0 ? void 0 : optionsMaybe.onInit) !== void 0) {
      ...
      function UseElementRef_unsupportedIterableToArray(o, minLen) {
        if (!o)
          return;
        if (typeof o === "string")
          return UseElementRef_arrayLikeToArray(o, minLen);
        var n = Object.prototype.toString.call(o).slice(8, -1);
        if (n === "Object" && o.constructor)
          n = o.constructor.name;
        if (n === "Map" || n === "Set")
      ...
      function UploadDropzone_unsupportedIterableToArray(o, minLen) {
        if (!o)
          return;
        if (typeof o === "string")
          return UploadDropzone_arrayLikeToArray(o, minLen);
        var n = Object.prototype.toString.call(o).slice(8, -1);
        if (n === "Object" && o.constructor)
          n = o.constructor.name;
        if (n === "Map" || n === "Set")
